...
public class CustomerController {
	...
	public static void start() throws IOException {
		...
		for (Branch branch : al) { // need to add condition that calls isopen() to only display branches that are
									// open
	...
	private static void newOrder(Branch branch) throws IOException { // add to cart function works
